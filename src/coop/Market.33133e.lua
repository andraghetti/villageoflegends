...
function AddAncientGuild()
    ...
    local expansion_decks = {
        ...
        getObjectFromGUID('466fee'), -- nuggets
        getObjectFromGUID('902eab'), -- monsters
        getObjectFromGUID('3e9f60'), -- main
    }
    local market_decks_zones = {
        MarketDeckZones.scrolls, MarketDeckZones.spells, MarketDeckZones.potions,
        MarketDeckZones.nuggets, MarketDeckZones.monsters, MarketDeckZones.main
    }
    -- Merge decks
...
function AddTheHorde()
    ...
    local expansion_decks = {
        ...
        getObjectFromGUID('3a1a32'), -- monsters
        getObjectFromGUID('bd1ee9'), -- main
    }
    local market_decks_zones = {
        MarketDeckZones.spells,
        MarketDeckZones.potions,
        MarketDeckZones.monsters,
        MarketDeckZones.main
    }
...
function AddReapersHand()
    ...
    local expansion_decks = {
        ...
        getObjectFromGUID('966bb5'), -- monsters
        getObjectFromGUID('c4b2ee'), -- main
    }
    local market_decks_zones = {
        MarketDeckZones.scrolls,
        MarketDeckZones.spells,
        MarketDeckZones.potions,
        MarketDeckZones.nuggets,
        MarketDeckZones.monsters,
        MarketDeckZones.main
    }
    -- Merge decks
